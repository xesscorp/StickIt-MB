...
\manualnum{002}
\manualversion{4.0.1}
\newcommand{\copyrightyear}{2012-2016}
...
\begin{xessrevisiontbl}
	...
	\hline
	02/01/2016 & 4.0.1 & Corrected pin assignment for pin D1 of PM2 connector 
                       from CH26 to CH16 on page~\pageref{appx:IO_Locations}.\\
\end{xessrevisiontbl}
